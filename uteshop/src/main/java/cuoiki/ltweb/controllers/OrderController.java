		...
		String status_payment = "paid";
			try {
				...
				if(paymentmethod.equals("COD")) {
					...
					status ="cardpayment";
				    String approveLink = PayPalService.createPayment(convertVNDToUSD(totalmoney), "USD", "https://uteshop.thaihungabc.id.vn/uteshop/user/orderpaypal/success",
				            "https://uteshop.thaihungabc.id.vn/uteshop/user/orderpaypal/cancel");
				    if (approveLink != null) {
